    ...
    Scaffold(
        ...
        Column(
            ...
            TransparentHintTextField(
                ...
                singleLine = true,
                onFocusChanged = { focusState -> viewModel.onNoteTitleFocusChanged(focusState.isFocused) },
            ...
            TransparentHintTextField(
                ...
                singleLine = true,
                onFocusChanged = { focusState -> viewModel.onNoteContentFocusChanged(focusState.isFocused) },
                textStyle = TextStyle(fontSize = 20.sp),
